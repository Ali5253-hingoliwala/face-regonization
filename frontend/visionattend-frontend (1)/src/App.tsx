...
export default function App() {
  return <AuthProvider><BrowserRouter><CookieConsent/><Routes>
    <Route path="/" element={<LandingPage />} /><Route path="/login" element={<LoginPage />} /><Route path="/signup" element={<><SignupConsentGate/><SignupPage /></>} /><Route path="/forgot-password" element={<ForgotPasswordPage />} /><Route path="/reset-password" element={<ResetPasswordPage />} /><Route path="/verify-email" element={<VerifyEmailPage />} />
  ...
  </Routes><AssistantWidget /></BrowserRouter></AuthProvider>;
}
