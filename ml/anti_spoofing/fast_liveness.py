...
class FastLivenessSignals:
    """One MediaPipe pass for blink, head direction and gaze."""
    ...
    def process(self, frame):
        ...
        left_ratio = _horizontal_ratio(
            left_iris, landmarks[LEFT_EYE_OUTER], landmarks[LEFT_EYE_INNER]
        )
        right_ratio = _horizontal_ratio(
            right_iris, landmarks[RIGHT_EYE_OUTER], landmarks[RIGHT_EYE_INNER]
        )
